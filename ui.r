...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem("Set columns", tabName = "cols"),
    menuItem("Run models", tabName = "models")
  )
)
...
body <- dashboardBody(
  tabItems(
    tabItem("intro", body.intro),
    tabItem("format", body.format),
    tabItem("load", body.load),
    tabItem("view", body.view),
    tabItem("cols", body.cols),
    tabItem("models", body.models)
  )
)
