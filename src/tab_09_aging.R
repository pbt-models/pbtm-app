    ...
    function(input, output, session) {
      ...
      output$content <- renderUI({
        ...
        validate(need(
          ready(),
          paste(
            "Please load required data for the aging model analysis. Minimum required columns are:",
        ...
        otherTrtCols <- setdiff(
          names(data()),
          c("AgingTime", "CumTime", "CumFraction")
        )
