    ...
    function(input, output, session) {
      ...
      output$content <- renderUI({
        ...
        validate(need(
          ready(),
          paste(
            "Please load a dataset with required columns for hydrotime analysis. Minimum required columns are:",
